...
static const struct brw_shader_reloc gfx30_bvh_build_BFS_categorize_builds_and_init_scheduler_relocs[] = {
};
static const u_printf_info gfx30_bvh_build_BFS_categorize_builds_and_init_scheduler_printfs[] = {
};
static const struct brw_kernel_arg_desc gfx30_bvh_build_BFS_categorize_builds_and_init_scheduler_args[] = {
   { 0, 8 },
   { 8, 8 },
   { 16, 8 },
   { 24, 8 },
...
fbl(1)          g3<1>UD         g98<0,1,0>UD                    { align1 WE_all 1N I@2 compacted };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N $0.src };
shl(1)          a0<1>UD         g3<0,1,0>UD     0x00000002UD    { align1 WE_all 1N I@1 };
add(1)          a0<1>UD         a0<0,1,0>UD     0x00001e00UD    { align1 WE_all 1N A@1 };
mov(1)          g5<1>UD         g[a0 128]<0,1,0>UD              { align1 WE_all 1N A@1 };
cmp.z.f0.0(32)  null<1>D        g8<8,8,1>D      g3<0,1,0>D      { align1 I@3 };
shl(1)          a0<1>UD         g5<0,1,0>UD     0x00000002UD    { align1 WE_all 1N I@2 };
add(1)          a0<1>UD         a0<0,1,0>UD     0x00001e00UD    { align1 WE_all 1N A@1 };
mov(1)          g7<1>UD         g[a0 384]<0,1,0>UD              { align1 WE_all 1N A@1 };
(+f0.0) if(32)  JIP:  LABEL15         UIP:  LABEL15             { align1 };
mov(32)         g122<1>UD       0x00000000UD                    { align1 compacted };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N I@3 };
mov(32)         g124<1>UD       g7<0,1,0>UD                     { align1 $0.src compacted };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N I@1 };
...
shl(1)          a0<1>UD         g21<0,1,0>UD    0x00000002UD    { align1 WE_all 1N I@1 };
add(1)          a0<1>UD         a0<0,1,0>UD     0x00000400UD    { align1 WE_all 1N A@1 };
mov(1)          g23<1>UD        g[a0 192]<0,1,0>UD              { align1 WE_all 1N A@1 };
(+f0.0) if(32)  JIP:  LABEL16         UIP:  LABEL16             { align1 };
mov(32)         g125<1>UD       0x00000004UD                    { align1 $0.src compacted };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N I@3 };
mov(32)         g3<1>UD         g23<0,1,0>UD                    { align1 compacted };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N I@1 };
...
mov(1)          g37<1>UD        g[a0 448]<0,1,0>UD              { align1 WE_all 1N A@1 };
shl(1)          a0<1>UD         g37<0,1,0>UD    0x00000002UD    { align1 WE_all 1N I@1 };
add(1)          a0<1>UD         a0<0,1,0>UD     0x00000800UD    { align1 WE_all 1N A@1 };
mov(1)          g39<1>UD        g[a0 192]<0,1,0>UD              { align1 WE_all 1N A@1 };
(+f0.0) if(32)  JIP:  LABEL17         UIP:  LABEL17             { align1 };
mov(32)         g4<1>UD         0x00000008UD                    { align1 $0.src compacted };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N I@3 };
mov(32)         g6<1>UD         g39<0,1,0>UD                    { align1 compacted };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N I@1 };
...
static const uint32_t gfx30_bvh_build_BFS_categorize_builds_and_init_scheduler_code[] = {
    ...
    0x00586005, 0x00000000, 0x2c841a4c, 0x00106203,
    0x8000a001, 0x00000000, 0x00000000, 0x00000000,
    0x80001969, 0x10018220, 0x02000304, 0x00000002,
    0x80000940, 0x10018220, 0x02001000, 0x00001e00,
    0x80000961, 0x05050220, 0x00010100, 0x00000000,
    0x00141b70, 0x00010660, 0x16460805, 0x00000304,
    0x80001a69, 0x10018220, 0x02000504, 0x00000002,
    0x80000940, 0x10018220, 0x02001000, 0x00001e00,
    0x80000961, 0x07050220, 0x00010300, 0x00000000,
    0x04140022, 0x0001c060, 0x00000050, 0x00000050,
    0x64a00061, 0x0000007a, 0x80001b01, 0x00000000,
    0x00000000, 0x00000000, 0x2ca0a061, 0x0010077c,
    0x80001901, 0x00000000, 0x00000000, 0x00000000,
    0x0014c031, 0x42140000, 0xea187a14, 0x01007c14,
    0x00140025, 0x00004600, 0x00000000, 0x00001678,
    ...
    0x80000961, 0x25050220, 0x00010380, 0x00000000,
    0x80001969, 0x10018220, 0x02002504, 0x00000002,
    0x80000940, 0x10018220, 0x02001000, 0x00000800,
    0x80000961, 0x27050220, 0x00010180, 0x00000000,
    0x04140022, 0x0001c060, 0x00000050, 0x00000050,
    0x64a0a061, 0x00800004, 0x80001b01, 0x00000000,
    0x00000000, 0x00000000, 0x2ca00061, 0x00102706,
    0x80001901, 0x00000000, 0x00000000, 0x00000000,
...
static const struct brw_kernel gfx30_bvh_build_BFS_categorize_builds_and_init_scheduler = {
   .prog_data = {
      .base.nr_params = 17,
      ...
      .base.num_relocs = 0,
      .base.relocs = gfx30_bvh_build_BFS_categorize_builds_and_init_scheduler_relocs,
      .base.printf_info_count = 0,
      .base.printf_info = (u_printf_info *)gfx30_bvh_build_BFS_categorize_builds_and_init_scheduler_printfs,
   ...
   .args_size = 36,
   .arg_count = 5,
   .args = gfx30_bvh_build_BFS_categorize_builds_and_init_scheduler_args,
   .code = gfx30_bvh_build_BFS_categorize_builds_and_init_scheduler_code,
};
const char *gfx30_bvh_build_BFS_categorize_builds_and_init_scheduler_sha1 = "3f0aab412c637461ccc18ca315eb1726c7934448";
