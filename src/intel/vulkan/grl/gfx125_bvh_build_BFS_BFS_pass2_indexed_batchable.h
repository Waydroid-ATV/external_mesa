...
and(16)         g64<1>UD        g57<1,1,0>UD    g51<1,1,0>UD    { align1 1H I@1 compacted };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N $15.dst };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N $13.src };
...
(-f0.0) sel(16) g65<1>UD        g51<8,8,1>UD    0x00000000UD    { align1 1H };
mov(1)          f0<1>UW         0x0000UW                        { align1 WE_all 1N };
...
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N I@3 };
shl(16)         g66<1>D         g1<0,1,0>D      g47<8,8,1>UD    { align1 1H };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N $12.src };
and.nz.f0.0(16) null<1>UD       g59<8,8,1>UD    g66<8,8,1>UD    { align1 1H I@1 };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N $12.src };
...
static const uint32_t gfx125_bvh_build_BFS_BFS_pass2_indexed_batchable_code[] = {
    ...
    0x00041961, 0x39050560, 0x00463f05, 0x00000000,
    0x20401965, 0x33003903, 0x80002f01, 0x00000000,
    ...
    0x11040062, 0x41058220, 0x02463305, 0x00000000,
    0x80000061, 0x30014110, 0x00000000, 0x00000000,
    ...
    0x00000000, 0x00000000, 0x00040069, 0x42050660,
    0x02000104, 0x00462f05, 0x80003c01, 0x00000000,
    0x00000000, 0x00000000, 0x00041965, 0x00010220,
    0x22463b05, 0x00464205, 0x80003c01, 0x00000000,
...
const char *gfx125_bvh_build_BFS_BFS_pass2_indexed_batchable_sha1 = "df24e60106a770b4ae0ca5b78ac31181c61af5c0";
