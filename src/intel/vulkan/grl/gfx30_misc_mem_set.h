...
static const struct brw_shader_reloc gfx30_misc_mem_set_relocs[] = {
};
static const u_printf_info gfx30_misc_mem_set_printfs[] = {
};
static const struct brw_kernel_arg_desc gfx30_misc_mem_set_args[] = {
   { 0, 8 },
   { 8, 4 },
   { 12, 4 },
};
...
static const uint32_t gfx30_misc_mem_set_code[] = {
...
static const struct brw_kernel gfx30_misc_mem_set = {
   .prog_data = {
      .base.nr_params = 12,
      ...
      .base.num_relocs = 0,
      .base.relocs = gfx30_misc_mem_set_relocs,
      .base.printf_info_count = 0,
      .base.printf_info = (u_printf_info *)gfx30_misc_mem_set_printfs,
   ...
   .args_size = 16,
   .arg_count = 3,
   .args = gfx30_misc_mem_set_args,
   .code = gfx30_misc_mem_set_code,
};
const char *gfx30_misc_mem_set_sha1 = "d9cdf8f9d4e530580897565740075bc1b9ae3b26";
