...
static const struct brw_shader_reloc gfx30_bvh_build_BFS_scheduler_relocs[] = {
};
static const u_printf_info gfx30_bvh_build_BFS_scheduler_printfs[] = {
};
static const struct brw_kernel_arg_desc gfx30_bvh_build_BFS_scheduler_args[] = {
   { 0, 8 },
   { 8, 8 },
};
...
fbl(1)          g26<1>UD        g64<0,1,0>UD                    { align1 WE_all 1N I@1 compacted };
mov(8)          g34<1>UW        0x76543210V                     { align1 WE_all 1Q };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N $9.src };
shl(1)          a0<1>UD         g26<0,1,0>UD    0x00000002UD    { align1 WE_all 1N I@2 };
add(1)          a0<1>UD         a0<0,1,0>UD     0x00000400UD    { align1 WE_all 1N A@1 };
mov(1)          g27<1>UD        g[a0 448]<0,1,0>UD              { align1 WE_all 1N A@1 };
...
mov(1)          g28<1>UD        g[a0 64]<0,1,0>UD               { align1 WE_all 1N A@1 };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N I@2 };
mov(16)         g29<1>UD        g34<8,8,1>UW                    { align1 1H };
cmp.z.f0.0(16)  null<1>D        g29<8,8,1>D     g26<0,1,0>D     { align1 1H I@1 };
(+f0.0) if(16)  JIP:  LABEL9          UIP:  LABEL9              { align1 1H };
mov(16)         g105<1>UD       0x00002004UD                    { align1 1H };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N I@5 };
mov(16)         g106<1>UD       g28<0,1,0>UD                    { align1 1H $1.src compacted };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N I@1 };
...
fbl(1)          g79<1>UD        g69<0,1,0>UD                    { align1 WE_all 1N I@1 compacted };
mov(8)          g83<1>UW        0x76543210V                     { align1 WE_all 1Q };
shl(1)          a0<1>UD         g79<0,1,0>UD    0x00000002UD    { align1 WE_all 1N I@2 };
add(1)          a0<1>UD         a0<0,1,0>UD     0x00001200UD    { align1 WE_all 1N A@1 };
mov(1)          g80<1>UD        g[a0 256]<0,1,0>UD              { align1 WE_all 1N A@1 };
...
cmp.z.f0.0(16)  null<1>D        g82<8,8,1>D     g79<0,1,0>D     { align1 1H I@1 };
(+f0.0) if(16)  JIP:  LABEL13         UIP:  LABEL13             { align1 1H };
mov(16)         g107<1>UD       0x00002000UD                    { align1 1H };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N I@5 };
mov(16)         g108<1>UD       g81<0,1,0>UD                    { align1 1H compacted };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N I@1 };
...
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N $9.src };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N I@1 };
mov(16)         g26<1>UQ        g35<8,4,2>UD                    { align1 1H };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N $0.src };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N I@1 };
...
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N $0.src };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N I@1 };
mov(16)         g27<1>UQ        g49<8,4,2>UD                    { align1 1H };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N $0.src };
...
static const uint32_t gfx30_bvh_build_BFS_scheduler_code[] = {
    ...
    0x00004b08, 0x00004b08, 0x00100061, 0x24054770,
    ...
    0x00100025, 0x00004600, 0x00000000, 0x00004090,
    ...
    0x00100025, 0x00004600, 0x00000000, 0x00000bb0,
    0xadd0a740, 0x67206615, 0x04100022, 0x0001c060,
    0x00000640, 0x00000640, 0x8000a301, 0x00000000,
    ...
    0x2c84194c, 0x0010401a, 0x800c0061, 0x22054410,
    ...
    0x02001000, 0x00000400, 0x80000961, 0x1b050220,
    0x00010380, 0x00000000, 0x800c1a40, 0x22458110,
    0x01462205, 0x00080008, 0x8000a001, 0x00000000,
    0x00000000, 0x00000000, 0x80001a69, 0x10018220,
    0x02001b04, 0x00000002, 0x80000940, 0x10018220,
    0x02001000, 0x00000600, 0x80000961, 0x1c050220,
    ...
    0x16461d05, 0x00001a04, 0x04100022, 0x0001c060,
    0x00000058, 0x00000058, 0x00100061, 0x69054220,
    0x00000000, 0x00002004, 0x80001d01, 0x00000000,
    0x00000000, 0x00000000, 0x2c80a161, 0x00101c6a,
    0x80001901, 0x00000000, 0x00000000, 0x00000000,
    ...
    0x02004504, 0xffffffff, 0x2c84194c, 0x0010454f,
    0x800c0061, 0x53054410, 0x00000000, 0x76543210,
    0x80001a69, 0x10018220, 0x02004f04, 0x00000002,
    0x80000940, 0x10018220, 0x02001000, 0x00001200,
    0x80000961, 0x50050220, 0x00010200, 0x00000000,
    0x800c1a40, 0x53458110, 0x01465305, 0x00080008,
    0x8000a301, 0x00000000, 0x00000000, 0x00000000,
    0x80001a69, 0x10018220, 0x02005004, 0x00000002,
    0x80000940, 0x10018220, 0x02001000, 0x00001200,
    0x80000961, 0x51050220, 0x00010300, 0x00000000,
    0x80001a01, 0x00000000, 0x00000000, 0x00000000,
    0x00100061, 0x52050120, 0x00465305, 0x00000000,
    0x00101970, 0x00010660, 0x16465205, 0x00004f04,
    0x04100022, 0x0001c060, 0x00000058, 0x00000058,
    0x00100061, 0x6b054220, 0x00000000, 0x00002000,
    0x80001d01, 0x00000000, 0x00000000, 0x00000000,
    0x2c800061, 0x0010516c, 0x80001901, 0x00000000,
    ...
    0x00000310, 0x000000d0, 0x8000af01, 0x00000000,
    ...
    0x00000250, 0x00000250, 0x00100040, 0x11058660,
    0x06005c04, 0xffffff00, 0x00101970, 0x00010220,
    0x52467005, 0x00461105, 0x04100022, 0x0001c060,
    0x000001b8, 0x000001b8, 0x0010a761, 0x14054770,
    ...
    0x8000a901, 0x00000000, 0x00000000, 0x00000000,
    0x80001901, 0x00000000, 0x00000000, 0x00000000,
    0x00100061, 0x1a050230, 0x00442306, 0x00000000,
    0x8000a001, 0x00000000, 0x00000000, 0x00000000,
    0x80001901, 0x00000000, 0x00000000, 0x00000000,
    ...
    0x00000350, 0x00000350, 0x00100041, 0x20018220,
    ...
    0x00000260, 0x00000260, 0x00101f69, 0x0c058660,
    ...
    0x8000a001, 0x00000000, 0x00000000, 0x00000000,
    0x80001901, 0x00000000, 0x00000000, 0x00000000,
    0x00100061, 0x1b050230, 0x00443106, 0x00000000,
    0x8000a001, 0x00000000, 0x00000000, 0x00000000,
    ...
    0x00000000, 0xfffffd90, 0x00100040, 0x6d058660,
    0x06466d05, 0x00000010, 0x00100027, 0x00014060,
    0x00000000, 0xfffffca0, 0x8000a001, 0x00000000,
    0x00000000, 0x00000000, 0x2c101f61, 0x0010007e,
    0x80101931, 0x00000004, 0x30007e0c, 0x00000000,
};
static const struct brw_kernel gfx30_bvh_build_BFS_scheduler = {
   .prog_data = {
      .base.nr_params = 12,
      ...
      .base.program_size = 27472,
      .base.const_data_size = 0,
      .base.const_data_offset = 0,
      .base.num_relocs = 0,
      .base.relocs = gfx30_bvh_build_BFS_scheduler_relocs,
      .base.printf_info_count = 0,
      .base.printf_info = (u_printf_info *)gfx30_bvh_build_BFS_scheduler_printfs,
   ...
   .args_size = 16,
   .arg_count = 2,
   .args = gfx30_bvh_build_BFS_scheduler_args,
   .code = gfx30_bvh_build_BFS_scheduler_code,
};
const char *gfx30_bvh_build_BFS_scheduler_sha1 = "ddb09a10514d9b55bf8872ce39894e4d6c2ad263";
