...
static const struct brw_shader_reloc gfx30_bvh_build_BFS_build_qnodes_init_scheduler_batched_relocs[] = {
};
static const u_printf_info gfx30_bvh_build_BFS_build_qnodes_init_scheduler_batched_printfs[] = {
};
static const struct brw_kernel_arg_desc gfx30_bvh_build_BFS_build_qnodes_init_scheduler_batched_args[] = {
   { 0, 8 },
   { 8, 4 },
   { 12, 4 },
};
...
static const uint32_t gfx30_bvh_build_BFS_build_qnodes_init_scheduler_batched_code[] = {
...
static const struct brw_kernel gfx30_bvh_build_BFS_build_qnodes_init_scheduler_batched = {
   .prog_data = {
      .base.nr_params = 12,
      ...
      .base.num_relocs = 0,
      .base.relocs = gfx30_bvh_build_BFS_build_qnodes_init_scheduler_batched_relocs,
      .base.printf_info_count = 0,
      .base.printf_info = (u_printf_info *)gfx30_bvh_build_BFS_build_qnodes_init_scheduler_batched_printfs,
   ...
   .args_size = 16,
   .arg_count = 3,
   .args = gfx30_bvh_build_BFS_build_qnodes_init_scheduler_batched_args,
   .code = gfx30_bvh_build_BFS_build_qnodes_init_scheduler_batched_code,
};
const char *gfx30_bvh_build_BFS_build_qnodes_init_scheduler_batched_sha1 = "99a36bacbd1516f6470dd65e582aea16bcbe902a";
