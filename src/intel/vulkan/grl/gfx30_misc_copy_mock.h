...
static const struct brw_shader_reloc gfx30_misc_copy_mock_relocs[] = {
};
static const u_printf_info gfx30_misc_copy_mock_printfs[] = {
};
static const struct brw_kernel_arg_desc gfx30_misc_copy_mock_args[] = {
   { 0, 8 },
   { 8, 8 },
   { 16, 4 },
};
...
static const uint32_t gfx30_misc_copy_mock_code[] = {
...
static const struct brw_kernel gfx30_misc_copy_mock = {
   .prog_data = {
      .base.nr_params = 13,
      ...
      .base.num_relocs = 0,
      .base.relocs = gfx30_misc_copy_mock_relocs,
      .base.printf_info_count = 0,
      .base.printf_info = (u_printf_info *)gfx30_misc_copy_mock_printfs,
   ...
   .args_size = 20,
   .arg_count = 3,
   .args = gfx30_misc_copy_mock_args,
   .code = gfx30_misc_copy_mock_code,
};
const char *gfx30_misc_copy_mock_sha1 = "821f6c9e4506ec356805561286fc5f3e81730922";
