...
static const struct brw_shader_reloc gfx30_misc_copy_geo_meta_data_relocs[] = {
};
static const u_printf_info gfx30_misc_copy_geo_meta_data_printfs[] = {
};
static const struct brw_kernel_arg_desc gfx30_misc_copy_geo_meta_data_args[] = {
   { 0, 8 },
   { 8, 8 },
   { 16, 8 },
};
...
mov(16)         g127<4>UB       g126<16,8,2>UB                  { align1 1H I@2 };
shl(16)         g109<1>D        g108<8,8,1>D    0x00000010UD    { align1 1H I@2 };
mov(16)         g107<1>UD       g127<32,8,4>UB                  { align1 1H I@2 };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N $7.dst };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N I@1 };
...
static const uint32_t gfx30_misc_copy_geo_meta_data_code[] = {
    ...
    0x00000428, 0x00000428, 0x00100069, 0x50058660,
    ...
    0x000002b8, 0x00000210, 0x80001a01, 0x00000000,
    ...
    0x000000b8, 0x000000b8, 0x80001a01, 0x00000000,
    ...
    0x00d66906, 0x00000000, 0x00101a61, 0x7f070000,
    0x00567e06, 0x00000000, 0x00101a69, 0x6d058660,
    0x02466c05, 0x00000010, 0x00101a61, 0x6b050020,
    0x00667f07, 0x00000000, 0x80008701, 0x00000000,
    0x00000000, 0x00000000, 0x80001901, 0x00000000,
    ...
    0x00100027, 0x00014060, 0x00000000, 0xfffffbc8,
    0x2c100061, 0x0010007e, 0x80101931, 0x00000004,
    0x30007e0c, 0x00000000, 0x20000060, 0x00000000,
};
static const struct brw_kernel gfx30_misc_copy_geo_meta_data = {
   .prog_data = {
      .base.nr_params = 14,
      ...
      .base.num_relocs = 0,
      .base.relocs = gfx30_misc_copy_geo_meta_data_relocs,
      .base.printf_info_count = 0,
      .base.printf_info = (u_printf_info *)gfx30_misc_copy_geo_meta_data_printfs,
   ...
   .args_size = 24,
   .arg_count = 3,
   .args = gfx30_misc_copy_geo_meta_data_args,
   .code = gfx30_misc_copy_geo_meta_data_code,
};
const char *gfx30_misc_copy_geo_meta_data_sha1 = "9c7f72141b548e5da28a0592f3f04fa50b0f516d";
