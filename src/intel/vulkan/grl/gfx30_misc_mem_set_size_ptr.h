...
static const struct brw_shader_reloc gfx30_misc_mem_set_size_ptr_relocs[] = {
};
static const u_printf_info gfx30_misc_mem_set_size_ptr_printfs[] = {
};
static const struct brw_kernel_arg_desc gfx30_misc_mem_set_size_ptr_args[] = {
   { 0, 8 },
   { 8, 4 },
   { 16, 8 },
};
...
static const uint32_t gfx30_misc_mem_set_size_ptr_code[] = {
...
static const struct brw_kernel gfx30_misc_mem_set_size_ptr = {
   .prog_data = {
      .base.nr_params = 14,
      ...
      .base.num_relocs = 0,
      .base.relocs = gfx30_misc_mem_set_size_ptr_relocs,
      .base.printf_info_count = 0,
      .base.printf_info = (u_printf_info *)gfx30_misc_mem_set_size_ptr_printfs,
   ...
   .args_size = 24,
   .arg_count = 3,
   .args = gfx30_misc_mem_set_size_ptr_args,
   .code = gfx30_misc_mem_set_size_ptr_code,
};
const char *gfx30_misc_mem_set_size_ptr_sha1 = "b1f10e7130e5c54cc95a0ca92f0c7825e945783a";
