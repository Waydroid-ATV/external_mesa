...
static const struct brw_shader_reloc gfx30_bvh_build_BFS_begin_batchable_relocs[] = {
};
static const u_printf_info gfx30_bvh_build_BFS_begin_batchable_printfs[] = {
};
static const struct brw_kernel_arg_desc gfx30_bvh_build_BFS_begin_batchable_args[] = {
   { 0, 8 },
   { 8, 8 },
};
...
static const uint32_t gfx30_bvh_build_BFS_begin_batchable_code[] = {
...
static const struct brw_kernel gfx30_bvh_build_BFS_begin_batchable = {
   .prog_data = {
      .base.nr_params = 12,
      ...
      .base.num_relocs = 0,
      .base.relocs = gfx30_bvh_build_BFS_begin_batchable_relocs,
      .base.printf_info_count = 0,
      .base.printf_info = (u_printf_info *)gfx30_bvh_build_BFS_begin_batchable_printfs,
   ...
   .args_size = 16,
   .arg_count = 2,
   .args = gfx30_bvh_build_BFS_begin_batchable_args,
   .code = gfx30_bvh_build_BFS_begin_batchable_code,
};
const char *gfx30_bvh_build_BFS_begin_batchable_sha1 = "28959a96fd34943019e48019b494d0951a791d3b";
