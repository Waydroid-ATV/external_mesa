...
static const struct brw_shader_reloc gfx30_bvh_postbuild_info_current_size_relocs[] = {
};
static const u_printf_info gfx30_bvh_postbuild_info_current_size_printfs[] = {
};
static const struct brw_kernel_arg_desc gfx30_bvh_postbuild_info_current_size_args[] = {
   { 0, 8 },
   { 8, 8 },
};
...
static const uint32_t gfx30_bvh_postbuild_info_current_size_code[] = {
...
static const struct brw_kernel gfx30_bvh_postbuild_info_current_size = {
   .prog_data = {
      .base.nr_params = 12,
      ...
      .base.num_relocs = 0,
      .base.relocs = gfx30_bvh_postbuild_info_current_size_relocs,
      .base.printf_info_count = 0,
      .base.printf_info = (u_printf_info *)gfx30_bvh_postbuild_info_current_size_printfs,
   ...
   .args_size = 16,
   .arg_count = 2,
   .args = gfx30_bvh_postbuild_info_current_size_args,
   .code = gfx30_bvh_postbuild_info_current_size_code,
};
const char *gfx30_bvh_postbuild_info_current_size_sha1 = "018705320a5cc83fa1839329347bc8f6c4776340";
