...
static const struct brw_shader_reloc gfx30_bvh_build_BFS_build_qnodes_scheduler_relocs[] = {
};
static const u_printf_info gfx30_bvh_build_BFS_build_qnodes_scheduler_printfs[] = {
};
static const struct brw_kernel_arg_desc gfx30_bvh_build_BFS_build_qnodes_scheduler_args[] = {
   { 0, 8 },
};
...
static const uint32_t gfx30_bvh_build_BFS_build_qnodes_scheduler_code[] = {
...
static const struct brw_kernel gfx30_bvh_build_BFS_build_qnodes_scheduler = {
   .prog_data = {
      .base.nr_params = 10,
      ...
      .base.num_relocs = 0,
      .base.relocs = gfx30_bvh_build_BFS_build_qnodes_scheduler_relocs,
      .base.printf_info_count = 0,
      .base.printf_info = (u_printf_info *)gfx30_bvh_build_BFS_build_qnodes_scheduler_printfs,
   ...
   .args_size = 8,
   .arg_count = 1,
   .args = gfx30_bvh_build_BFS_build_qnodes_scheduler_args,
   .code = gfx30_bvh_build_BFS_build_qnodes_scheduler_code,
};
const char *gfx30_bvh_build_BFS_build_qnodes_scheduler_sha1 = "8bf11bcf81c1bbad06b8fa20619ad83e1f85ac0a";
