...
static const struct brw_shader_reloc gfx30_bvh_copy_clone_indirect_relocs[] = {
};
static const u_printf_info gfx30_bvh_copy_clone_indirect_printfs[] = {
};
static const struct brw_kernel_arg_desc gfx30_bvh_copy_clone_indirect_args[] = {
   { 0, 8 },
   { 8, 8 },
};
...
static const uint32_t gfx30_bvh_copy_clone_indirect_code[] = {
...
static const struct brw_kernel gfx30_bvh_copy_clone_indirect = {
   .prog_data = {
      .base.nr_params = 12,
      ...
      .base.num_relocs = 0,
      .base.relocs = gfx30_bvh_copy_clone_indirect_relocs,
      .base.printf_info_count = 0,
      .base.printf_info = (u_printf_info *)gfx30_bvh_copy_clone_indirect_printfs,
   ...
   .args_size = 16,
   .arg_count = 2,
   .args = gfx30_bvh_copy_clone_indirect_args,
   .code = gfx30_bvh_copy_clone_indirect_code,
};
const char *gfx30_bvh_copy_clone_indirect_sha1 = "7672d43edbe357aba03ce2dc63b2e4cda8edf2fa";
