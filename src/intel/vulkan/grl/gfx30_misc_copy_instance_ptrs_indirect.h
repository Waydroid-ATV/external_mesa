...
static const struct brw_shader_reloc gfx30_misc_copy_instance_ptrs_indirect_relocs[] = {
};
static const u_printf_info gfx30_misc_copy_instance_ptrs_indirect_printfs[] = {
};
static const struct brw_kernel_arg_desc gfx30_misc_copy_instance_ptrs_indirect_args[] = {
   { 0, 8 },
   { 8, 8 },
   { 16, 8 },
};
...
static const uint32_t gfx30_misc_copy_instance_ptrs_indirect_code[] = {
...
static const struct brw_kernel gfx30_misc_copy_instance_ptrs_indirect = {
   .prog_data = {
      .base.nr_params = 14,
      ...
      .base.num_relocs = 0,
      .base.relocs = gfx30_misc_copy_instance_ptrs_indirect_relocs,
      .base.printf_info_count = 0,
      .base.printf_info = (u_printf_info *)gfx30_misc_copy_instance_ptrs_indirect_printfs,
   ...
   .args_size = 24,
   .arg_count = 3,
   .args = gfx30_misc_copy_instance_ptrs_indirect_args,
   .code = gfx30_misc_copy_instance_ptrs_indirect_code,
};
const char *gfx30_misc_copy_instance_ptrs_indirect_sha1 = "034b7cd54f5fe35fd8b9cf0de6812c884f36b174";
