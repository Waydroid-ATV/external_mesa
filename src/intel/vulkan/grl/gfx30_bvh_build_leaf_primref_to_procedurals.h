...
static const struct brw_shader_reloc gfx30_bvh_build_leaf_primref_to_procedurals_relocs[] = {
};
static const u_printf_info gfx30_bvh_build_leaf_primref_to_procedurals_printfs[] = {
};
static const struct brw_kernel_arg_desc gfx30_bvh_build_leaf_primref_to_procedurals_args[] = {
   { 0, 8 },
   { 8, 8 },
   { 16, 8 },
   { 24, 8 },
...
mov(16)         g20<2>B         3W                              { align1 1H $1.src };
add(8)          g68.8<1>UW      g68<8,8,1>UW    0x0008UW        { align1 WE_all 1Q I@2 };
mov(16)         g4<4>UB         g20<16,8,2>UB                   { align1 1H I@2 };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N I@2 };
...
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N $1.src };
mov(16)         g21<2>UD        g9<1,1,0>UD                     { align1 1H compacted };
mov(16)         g78<1>UQ        g21<8,4,2>UD                    { align1 1H I@1 };
...
mov(16)         g22<2>UD        g86<1,1,0>UD                    { align1 1H I@1 compacted };
mov(16)         g87<1>UQ        g22<8,4,2>UD                    { align1 1H I@1 };
...
mov(16)         g23<2>UD        g99<1,1,0>UD                    { align1 1H compacted };
mov(16)         g104<1>UQ       g23<8,4,2>UD                    { align1 1H I@1 };
...
mov(16)         g24<2>UD        g106<4,4,1>UQ                   { align1 1H I@1 };
mov(16)         g107<1>UD       g24<8,4,2>UD                    { align1 1H I@1 };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N I@1 };
...
mov(16)         g26<2>UD        g14<1,1,0>UD                    { align1 1H $6.dst compacted };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N $6.src };
mov(16)         g108<1>UQ       g26<8,4,2>UD                    { align1 1H I@1 };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N $8.src };
...
mov(16)         g115<1>UD       g4<32,8,4>UB                    { align1 1H $6.dst };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N I@1 };
...
static const uint32_t gfx30_bvh_build_leaf_primref_to_procedurals_code[] = {
    ...
    0x0010a161, 0x14064540, 0x00000000, 0x00030003,
    0x800c1a40, 0x44458110, 0x01464405, 0x00080008,
    0x00101a61, 0x04070000, 0x00561406, 0x00000000,
    ...
    0x8000a101, 0x00000000, 0x00000000, 0x00000000,
    0xb4000061, 0x00100915, 0x00101961, 0x4e050230,
    0x00441506, 0x00000000, 0x38001940, 0x46004e50,
    ...
    0x01460f05, 0x0000022c, 0x00100061, 0x59050230,
    0x00000234, 0x00000000, 0xe8180070, 0x09000f64,
    0x00101b40, 0x560e0110, 0x0156560e, 0x00567a06,
    0xb4001961, 0x00105616, 0x00101961, 0x57050230,
    0x00441606, 0x00000000, 0x38001940, 0x5900575b,
    ...
    0x00100025, 0x00004600, 0x00000000, 0x00000f90,
    ...
    0xb4000061, 0x00106317, 0x00101961, 0x68050230,
    0x00441706, 0x00000000, 0x04100022, 0x0001c060,
    0x00000f00, 0x00000f00, 0x00101f70, 0x00010220,
    0x52464505, 0x00000a04, 0x04100022, 0x0001c060,
    0x00000168, 0x00000158, 0x0010a669, 0x6a058770,
    0x02344605, 0x00000002, 0x00101961, 0x18060320,
    0x00346a05, 0x00000000, 0x00101961, 0x6b050220,
    0x00441806, 0x00000000, 0x80001901, 0x00000000,
    0x00000000, 0x00000000, 0x0010c631, 0x0e0c0000,
    0xea006b0c, 0x00000000, 0xb4008661, 0x00100e1a,
    0x8000a601, 0x00000000, 0x00000000, 0x00000000,
    0x00101961, 0x6c050230, 0x00441a06, 0x00000000,
    ...
    0x00100025, 0x00004600, 0x00000000, 0x00000d78,
...
static const struct brw_kernel gfx30_bvh_build_leaf_primref_to_procedurals = {
   .prog_data = {
      .base.nr_params = 20,
      ...
      .base.num_relocs = 0,
      .base.relocs = gfx30_bvh_build_leaf_primref_to_procedurals_relocs,
      .base.printf_info_count = 0,
      .base.printf_info = (u_printf_info *)gfx30_bvh_build_leaf_primref_to_procedurals_printfs,
   ...
   .args_size = 48,
   .arg_count = 7,
   .args = gfx30_bvh_build_leaf_primref_to_procedurals_args,
   .code = gfx30_bvh_build_leaf_primref_to_procedurals_code,
};
const char *gfx30_bvh_build_leaf_primref_to_procedurals_sha1 = "b54e1a580ba6f87d0401e76376aeb36bf51297b5";
