...
static const struct brw_shader_reloc gfx30_bvh_build_BFS_begin_relocs[] = {
};
static const u_printf_info gfx30_bvh_build_BFS_begin_printfs[] = {
};
static const struct brw_kernel_arg_desc gfx30_bvh_build_BFS_begin_args[] = {
   { 0, 8 },
   { 8, 4 },
   { 12, 4 },
   { 16, 8 },
...
static const uint32_t gfx30_bvh_build_BFS_begin_code[] = {
...
static const struct brw_kernel gfx30_bvh_build_BFS_begin = {
   .prog_data = {
      .base.nr_params = 27,
      ...
      .base.num_relocs = 0,
      .base.relocs = gfx30_bvh_build_BFS_begin_relocs,
      .base.printf_info_count = 0,
      .base.printf_info = (u_printf_info *)gfx30_bvh_build_BFS_begin_printfs,
   ...
   .args_size = 76,
   .arg_count = 11,
   .args = gfx30_bvh_build_BFS_begin_args,
   .code = gfx30_bvh_build_BFS_begin_code,
};
const char *gfx30_bvh_build_BFS_begin_sha1 = "b428ba467572faefbfc447b4615126a04d0755a6";
